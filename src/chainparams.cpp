...
public:
    CMainParams() {
        ...
        consensus.BIP34Height = 5655;  // DevMurfCoin - When BIP34 becomes enforced
        consensus.BIP34Hash = uint256S("b9f7a8cd379bb1d8ce7eb9553f7ca915af09a673dbab91ca0b145b56901e6544"); // DevMurfCoin - When BIP34 becomes enforced
        consensus.BIP65Height = 5655; // b9f7a8cd379bb1d8ce7eb9553f7ca915af09a673dbab91ca0b145b56901e6544
        consensus.BIP66Height = 5655; // b9f7a8cd379bb1d8ce7eb9553f7ca915af09a673dbab91ca0b145b56901e6544
		...
		**/
        ...
        checkpointData = (CCheckpointData) {
            {
                {  0, uint256S("0x33f08a949c3fc227e9b9cf16176a56fd2377d240c1eaa4a5bf3a9d5e22395878")}
            }
        };
...
public:
    CTestNetParams() {
		...
		**/
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000000000000002e2657ce");
