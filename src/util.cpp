...
const char * const BITCOIN_CONF_FILENAME = "murfcoin.conf";
const char * const BITCOIN_PID_FILENAME = "murfcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Murfcoin";
#else
    // Unix
