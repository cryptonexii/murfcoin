...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s murfcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  murfcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded murfcoin transaction") + "\n" +
              "  murfcoin-tx [options] -create [commands]   " + _("Create hex-encoded murfcoin transaction") + "\n" +
              "\n";
