...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " murfcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  murfcoin-tx [options] <hex-tx> [commands]  Update hex-encoded murfcoin transaction\n" +
            "or:     murfcoin-tx [options] -create [commands]   Create hex-encoded murfcoin transaction\n" +
            "\n";
