...
bech32_templates = [
  ...
  ('fluff',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('fluff',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('fluff',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
...
bech32_ng_templates = [
  ...
  ('fluff',   15, 41, False, False, False),
  ('tltc',  0, 16, False, False, False),
  ('rltc',  0, 32, True,  False, False),
  ('fluff',   0, 16, True,  False, False),
