...
"""Verify that starting murfcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start murfcoin with -h for help text")
        ...
        self.log.info("Start murfcoin with -version for version information")
        ...
        self.log.info("Start murfcoind with -fakearg to make sure it does not start")
