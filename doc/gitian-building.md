...
Output from `gbuild` will look something like
    ...
    From https://github.com/cryptonexii/murfcoin
...
[cryptonexii/gitian.sigs.fluff](https://github.com/cryptonexii/gitian.sigs.fluff/) repository, or if that's not possible create a pull
