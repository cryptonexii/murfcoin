# Support for Output Descriptors in Murfcoin Core

Since Murfcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Murfcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Murfcoin Core wallets, a convenience function `combo` is
