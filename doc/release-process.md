...
### Build and sign Murfcoin Core for Linux, Windows, and OS X:
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import murfcoin/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
Codesigner only: Sign the osx binary:
    ...
    transfer murfcoin-osx-unsigned.tar.gz to osx for signing
...
- Announce the release:
  ...
  - murfcoin-dev and murfcoin-dev mailing list
